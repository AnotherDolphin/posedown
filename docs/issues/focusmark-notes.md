...
- ❌ when formatting a new element by typing the last delimiter at the word beginning `|italic*` the caret jumps forward by delimiter length (after i in this ex) breaking the previously precise caret handling of smartReplaceChildren
